...
Both runtime databases must be generated by their current importers and pass schema
validation. The audio filename is a deployment convention; the ZIP body is not
rewritten. Keep the source assets backed up outside the repository. The included Compose
